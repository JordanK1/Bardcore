...
namespace Bardcore.Controllers
{
    public class UserPlaylistTracksController : Controller
    {
        ...
        {
            ViewData["PlaylistId"] = new SelectList(_context.UserPlaylist, "PlaylistId", "PlaylistId");
            ViewData["TrackId"] = new SelectList(_context.SongInfo, "TrackId", "TrackId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PlaylistTrackId,PlaylistId,TrackId")] UserPlaylistTrack userPlaylistTrack)
        {
            ...
            ViewData["PlaylistId"] = new SelectList(_context.UserPlaylist, "PlaylistId", "PlaylistId", userPlaylistTrack.PlaylistId);
            ViewData["TrackId"] = new SelectList(_context.SongInfo, "TrackId", "TrackId", userPlaylistTrack.TrackId);
            return View(userPlaylistTrack);
        }
